...
.proc update_player_1
  ...
  BCC no_ball_collision               ; If carry clear, no collision
    ...
    LDA #$02                          ; Set ball X velocity to +1 (right)
    STA ball_dx
  no_ball_collision:
...
.proc update_player_2
  ...
  ; Test for collision
  JSR collision_test                  ; Call collision detection subroutine
  BCC no_ball_collision               ; If carry clear, jump to no collision
    ; Collision detected - bounce ball to the left
    LDA #$FE                          ; Set ball X velocity to -1 (left)
    STA ball_dx
  no_ball_collision:
